...
//            }
            ...
            $this->assign('historyin',$historyin);

            $this->assign("totaltax",$totaltax);
            $this->assign('selftax',$selftax);

            $this->assign("alltt",$allmoney);
            $this->assign('selfmoney',$selfmoney);
//            $this->assign("zrsy",$yesterdaymoney);
            $this->assign("recharge",$recharge);

            $this->assign('selftodaytax',$selftodaytax);
            $this->assign('alltodaytax',$alltodaytax);


            $this->assign("alltodaymoney",$alltodaymoney);
            $this->assign('selftodaymoney',$selftodaymoney);
